  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
      <div class="container">
        <a href="assets/index3.html" class="navbar-brand">
          ...
          <span class="brand-text font-weight-light">Aplikasi Pemesanan Hotel Hebat</span>
        </a>
    ...
    <div class="content-wrapper">
                  ...
                  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="assets/gambar/g1_.jpg" alt="First slide" height="450">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="assets/gambar/g2_.jpg" alt="Second slide" height="450">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="assets/gambar/g3_.jpg" alt="Third slide" height="450">
                      </div>
                    </div>
      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">Universitas Teknologi Sumbawa</a>.</strong> All rights reserved.
      </footer>
    </div>
    <!-- ./wrapper -->
